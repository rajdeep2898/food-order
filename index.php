      ...
      <div class="navbar-fixed">
        <nav class="navbar-color">
          <div class="nav-wrapper">
            <ul class="left">
              <li>
                <h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/materialize-logo.png" height="300" width="300" alt="logo"></a> <span class="logo-text">Logo</span></h1>
              </li>
            </ul>
            <ul class="right hide-on-med-and-down">
              <li><a href="#" class="waves-effect waves-block waves-light"><i class="fa fa-rupee">&#8377;<?php echo $balance; ?></i></a>
              </li>
            </ul>
          </div>
        </nav>
                      ...
                      ?>
                        <li>
                          <div class="card col" style="width:200px">
                            <img class="card-img-top" src="<?php echo  $row["img_location"]; ?>" alt="Card image" style="width:100%">
                            <div class="card-body">
                              <h4 class="card-title"><?php echo $row["name"]; ?></h4>
                              <p class="card-text">
                                <div class="input-field col s12"><label for=<?php echo $row["id"]; ?> class="">Quantity</label>
                              </p>
                              <p class="card-text"><input id="<?php echo  $row["id"]; ?>" name="<?php echo  $row["id"]; ?>" type="text" data-error=".errorTxt<?php echo  $row["id"]; ?>">
