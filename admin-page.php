      ...
      <div class="wrapper">
        ...
        <section id="content">
          ...
          <div class="container">
            ...
            <form class="formValidate" id="formValidate1" method="post" enctype="multipart/form-data" action="routers/add-item.php" novalidate="novalidate">
              <div class="row">
                <div class="col s12 m4 l3">
                ...
                <div>
                  <table>
                    ...
                    <tbody>
                      ...
                      echo '<input name="image" id="image" type="file" class="inputFile"  data-error=".errorTxt02"><div class="errorTxt02"></div></td>';
                      echo '<td></tr>';
                      ?>
                    </tbody>
                  </table>
